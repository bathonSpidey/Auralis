...
class App:
    def __init__(self):
        ...
        if not self.cookies.ready():
            ...
            st.stop()
        self.openai_api_key = self.cookies.get(
        ...
        self.token_info = self.cookies.get(
            "token_info") if self.cookies.ready() else None
    ...
    def run(self):
        ...
        if not self.openai_api_key:
            ...
            self.model = st.selectbox(
                "Select Model",
                ["gemini-2.0-flash", "gpt-4.1", "gpt-4o",
                    "o4-mini", "local_lm_studio"],
                index=0,
        ...
        user_playlist_prompt = st.text_input("📝 What's your vibe today? 🎶\n"
        ...
        st.divider()
        st.caption(
            "🚀 Built with ❤️ powered by Curiosity, Spotify, and Streamlit")
